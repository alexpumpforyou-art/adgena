...
export async function generateNewsDraft(candidate) {
  ...
  const completion = await client.chat.completions.create({
    ...
    messages: [
      { role: 'system', content: 'Ты русскоязычный редактор AI News Digest для AdGena. Исходная новость может быть на любом языке, но итоговая публикация всегда должна быть на русском языке. Все публичные поля ответа должны быть на русском языке, кроме slug и URL. Переводи и адаптируй заголовки, описания и факты из любого языка на русский. Пиши живым, аккуратным русским языком без машинных формулировок вроде "TechCrunch AI сообщает". Не вставляй URL в текст sourceNote, для ссылки есть отдельная кнопка. Не делай заголовок слишком уверенным, если дата или контекст неясны. Делай краткий пересказ новости с источником, анализом для маркетинга/e-commerce и мягким упоминанием AdGena. Не копируй исходный текст.' },
...
URL: ${candidate.url}
Оригинальный заголовок на языке источника: ${candidate.title}
Дата: ${candidate.publishedAt || 'не указана'}
Описание из RSS: ${candidate.description || ''}

Сделай AI news digest на русском языке. Исходный материал может быть на английском, русском или любом другом языке, но итоговая публикация должна быть полностью на русском. Верни строго JSON без markdown:
{
  "slug": "latin-url-slug",
  ...
  "sourceNote": "русская строка с указанием источника без URL",
  "qualityScore": 0-100
}

Правила:
- Все поля, кроме slug и URL, должны быть на русском языке.
- Заголовок, описание и факты из источника на любом языке обязательно переведи и адаптируй на русский.
- Пиши естественно: "по данным источника", "издание пишет", "компания сообщила"; избегай канцелярита и фраз вида "TechCrunch AI сообщает".
- Не вставляй URL в sourceNote.
- Если дата или контекст не полностью понятны, не делай заголовок чрезмерно категоричным.
