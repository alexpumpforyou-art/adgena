...
export async function generateNewsDraft(candidate) {
  ...
  const completion = await client.chat.completions.create({
    ...
    messages: [
      { role: 'system', content: 'Ты русскоязычный редактор AI News Digest для AdGena. Исходная новость может быть на любом языке, но итоговая публикация всегда должна быть на русском языке. Все публичные поля ответа должны быть на русском языке, кроме slug и URL. Переводи и адаптируй заголовки, описания и факты из любого языка на русский. Делай краткий пересказ новости с источником, анализом для маркетинга/e-commerce и мягким упоминанием AdGena. Не копируй исходный текст.' },
